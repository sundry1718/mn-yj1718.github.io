...
$cfg_basehost = 'http://www.bjcs.com';
$cfg_cmspath = '';
$cfg_cookie_encode = 'XM2UMlHgOtWOQfM5hau9hWxyoW0an8';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '水质分析测量仪器-COD多参数在线检测仪表-杭州阳健仪表公司';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright @ 2021 杭州阳健自动化仪表有限公司 All Rights Reserved.';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '测量仪器,水质分析仪,在线检测仪,多参数测试仪器';
$cfg_description = '杭州阳健自动化仪表有限公司专注于:COD,氨氮水质分析仪器检测设备;pH,DO,MLSS多参数在线检测测试仪表;超声波液位计、浮球(开关)等的设计、开发、厂家价格供应、校准维修、原理精度、使用说明书、指导服务为合一的仪器仪表企业';
$cfg_beian = '浙ICP备16047801号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
...
$cfg_qq = '2922956308';
$cfg_gg = '杭州阳健自动化仪表有限公司欢迎您！';
$cfg_tel = '400-168-7828';
$cfg_telz = '0571-2811 7811';
$cfg_addz = '杭州市江干区笕丁路168号';
$cfg_telf = '400-168-7828';
$cfg_addf = '有什么问题请随时联系我们';
$cfg_tels = '130 2369 0355';
$cfg_adds = '安装调试相关事宜请联系';
$cfg_mc = '杭州阳健自动化仪表有限公司';
?>